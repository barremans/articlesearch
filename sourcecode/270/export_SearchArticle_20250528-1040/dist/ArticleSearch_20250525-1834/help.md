...
- Als er een update is, krijg je een melding
- Je kan handmatig bijwerken via:
  - Menu: `? > Over...`
  - Knop: `Update nu`
  - Er wordt dan een ZIP-bestand geopend in je browser
...
- **Bugmelding**  
  → opent een **GitHub Issue** met jouw beschrijving en naam
- **Feature-aanvraag**  
  → opent een **Pull Request** met een markdown-bestand in de repo en jouw voorstel
