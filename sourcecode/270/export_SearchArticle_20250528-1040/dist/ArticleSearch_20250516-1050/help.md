...
- 📦 Barcode: positie (top/left)
- 📝 Beschrijving: positie + breedte
- 📅 Datum: positie (top/left)
- 🧾 Inboundnummer: positie
- 📇 Leveranciersref.: positie

Wijzigingen worden bewaard in `settings.json` en direct toegepast.
...
- Bestanden in project:
  ...
  - `label_generator.py`, `label_settings_dialog.py`
  - `help.md`, `settings.json`, `requirements.txt`
  - `assets/`, `css/`, `logs/`, `dist/`, `label_settings.py`
