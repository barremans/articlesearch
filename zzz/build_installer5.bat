...
:: Strip expliciet ongewenste systeem/andere user Python paden (voorkomt Permission denied op vcruntime)
...
:: [3a] Icoonpad (robuust)
:: =========================
:: Override via env ABS_ICON_PATH is mogelijk; anders fallback naar projecticoon
...
:: Optionele Code-sectie inlezen als aanwezig
